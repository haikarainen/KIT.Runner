...
namespace msdfgen
{
  ...
  LinearSegment::LinearSegment(Point2 p0, Point2 p1, EdgeColor edgeColor)
  ...
  QuadraticSegment::QuadraticSegment(Point2 p0, Point2 p1, Point2 p2, EdgeColor edgeColor)
      : EdgeSegment(edgeColor)
  {
    if (p1 == p0 || p1 == p2)
      p1 = 0.5 * (p0 + p2);
  ...
  CubicSegment::CubicSegment(Point2 p0, Point2 p1, Point2 p2, Point2 p3, EdgeColor edgeColor)
      : EdgeSegment(edgeColor)
  {
